...
<head>
    ...
    <!-- Fav and touch icons -->
    <title>MyScholarships - Update Universities</title>
...
<div id="wrapper">
    ...
    $result1 = executeQuery("select * from msuniversity where UniversityId = $value");
                ...
                <div class="col-sm-9 page-content">
                    <div class="inner-box">
                        <div class="welcome-msg">
                            <h3 class="page-sub-header2 clearfix no-padding mb20">Update University : <?php echo $row['UName']; ?></h3>
                        </div>
                        <form action="../admin/mod/doupdateuniversity.php" method="post" class="form-horizontal col-sm-12" enctype="multipart/form-data" role="form">
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label pt7 text-right">Name</label>

                                                <div class="col-sm-9">
                                                    <input name="UName" type="text" class="form-control" placeholder="University Name">
                                                </div>
                                            </div>
                                             <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input name="ULogo" class="form-control p11" type="file" >
                                                </div>
                                            </div>
