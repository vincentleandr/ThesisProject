...
<head>
    ...
    <!-- Fav and touch icons -->
    <title>MyScholarships - Update Blog</title>
...
<?php  
    ...
    $result1 = executeQuery("select * from msblog where BlogId = $value");
    $row = mysql_fetch_array($result1)
?>
                <div class="col-sm-9 page-content">
                    <div class="inner-box">
                        <div class="welcome-msg">
                            <h3 class="page-sub-header2 clearfix no-padding mb20">Update Blog : <?php echo $row['BTitle']?>  </h3>
                        </div>
                        <form action="mod/doupdateblog.php" method="post" class="form-horizontal col-sm-12" enctype="multipart/form-data" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea name="BContent" class="form-control" placeholder="Content..." cols="10" rows="30"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
