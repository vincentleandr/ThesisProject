...
<head>
    ...
    <!-- Fav and touch icons -->
    <title>MyScholarships - Admin Blog</title>
                ...
                <div class="col-sm-9 page-content">
                    <div class="inner-box">
                        <div class="welcome-msg">
                            <h3 class="page-sub-header2 clearfix no-padding mb20">Blog </h3>
                        ...
                        <div class="welcome-msg">
                        	...
                        	<ul class="">
                                ...
                                <li>
                                	<a class="btn btn-primary" href="admin-add-blog.php"><i class="fa fa-plus fa-fw"></i> Add</a>
                                </li>
                            </ul>
                        ...
                        $start =0;
                            ...
                            $result2 = executeQuery("select * from msblog where BTitle like '%".$searchkey."%'limit $start,$limit");
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading-sm">
                                    <a href="<?php echo $pagar; echo $collapse;?>" data-toggle="collapse">
                                    	<h4 class="panel-title col-sm-10 col-xs-10 col-xxs-9 title-overflow"><?php echo $row[2] ?></h4>
                                    </a>

                                    <a class="btn-primary btn-admin" href="admin-update-blog.php?name=<?php echo $row[0]; ?>"><i class="fa fa-pencil-square-o fa-fw"></i></a>
                                    ...
                                    <div id="<?php echo $popup; echo $collapse;?>" class="overlay">
                                        <div class="popup">
                                            ...
                                            <div class="content">
                                                ...
                                                <a class="btn btn-primary" href="mod/dodeleteblog.php?namedelete=<?php echo $row[0] ?>">
						...
						<div id="accordion" class="panel-group" style="margin:0;">
                            <div class="panel panel-default">
                                <div class="panel-heading-sm">
                                    <a href="<?php echo $pagar; echo $collapse;?>" data-toggle="collapse">
                                        <h4 class="panel-title col-sm-10 col-xs-10 col-xxs-9"><?php echo $row[2] ?></h4>
                                    </a>
                        ...
                        <!--Search Result-->
                            ...
                            <div class="pagination-bar text-center">
                                <ul class="pagination">
                                    ...
                                    <li><a class="pagination-btn" href="admin-blog.php?Id=<?php echo ($Id-1);?>">&laquo; Prev </a></li>
                                    ...
                                    <li><a href="admin-blog.php?Id=<?php echo $i;?>"><?php echo $i; ?></a></li>  
                                    ...
                                    <li><a class="pagination-btn" href="admin-blog.php?Id=<?php echo ($Id+1);?>">Next &raquo;</a></li>
                                    
                                    <?php  
                                    }else{
                                    ?>
                                    
                                    <li><a class="pagination-btn" href="admin-blog.php?Id=<?php echo ($total);?>">Next &raquo;</a></li>
                            ...
                            <div class="pagination-bar text-center">
                                <ul class="pagination">
                                    ...
                                    <li><a class="pagination-btn" href="admin-blog.php?Id=<?php echo ($totals);?>&searchkey=<?php echo $searchkey;?>">Next &raquo;</a></li>
