...
<head>
    ...
    <!-- Fav and touch icons -->
    <title>MyScholarships - Add Scholarships</title>
                ...
                <div class="col-sm-9 page-content">
                    <div class="inner-box">
                        <div class="welcome-msg">
                            <h3 class="page-sub-header2 clearfix no-padding mb20">Add New Scholarships </h3>
                        </div>
                        <form action="../admin/mod/doaddscholarship.php" method="post" class="form-horizontal col-sm-12" role="form">
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label pt7 text-right">Title</label>

                                                <div class="col-sm-9">
                                                    <input name="STitle" type="text" class="form-control" placeholder="Title" autofocus>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                            	<label class="col-sm-3 control-label pt7 text-right">Program</label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <select name="SGPA" class="form-control">
                                                ...
                                                <div class="multi-check radio">
                                                        ...
                                                        <div class="w100 dropdown-form">
                                                            ...
                                                            <label class="display-block" for="Type2">
                                                                <input type="checkbox" name="SType[]" id="Type2" value="Financial Scholarships"/>
