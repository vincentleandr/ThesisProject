                ...
                <div class="col-sm-9 page-content">
                    <div class="inner-box">
                        <div class="welcome-msg">
                            <h3 class="page-sub-header2 clearfix no-padding mb20">Scholarships</h3>
                            <div>
                        ...
                        <div class="welcome-msg">
                        	...
                        	<ul class="">
                                ...
                                <li>
                                	<a class="btn btn-primary" href="admin-add-scholarships.php"><i class="fa fa-plus fa-fw"></i> Add</a>
                                </li>
                            </ul>
                        ...
                        error_reporting(0);
                            ...
                            $start=($Id-1)*$limit;
                             ...
                             $result1 = executeQuery("select * from msscholarship order by ScholarshipId desc limit $start,$limit"); 
                             $result3 =executeQuery("select * from msscholarship");
                            ...
                            $result2 = executeQuery("select * from msscholarship where STitle like '%".$searchkey."%'limit $start,$limit");
                        ...
                        <div id="accordion" class="panel-group" style="margin:0;">
                            <div class="panel panel-default">
                                <div class="panel-heading-sm">
                                    ...
                                    <a class="btn-primary btn-admin" href="admin-update-scholarships.php?name=<?php echo $row[0]; ?>"><i class="fa fa-pencil-square-o fa-fw"></i></a>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td> : </td>
                                                <td> <a href="<?php echo $row[12] ?>" target="_blank"><?php echo $row[12] ?></a></td>
                                            </tr><tr>
                                        ...
                                        <hr>
                                        <span><i class="fa fa-arrow-circle-right fa-fw"></i><a href="admin-scholarships-applicants.php?applicantid=<?php echo $row[0]?>" style="text-decoration:underline;">List of Applicants</a></span>
                                    </div>
                               </div>
                            </div>
                            <!--Tampilan Awal-->
                        ...
                        <!--Search Result-->
                            ...
                            <div class="pagination-bar text-center">
                                ...
                                <?php
                                    if($Id>1){
                                ?>
                                 <li><a class="pagination-btn" href="admin-scholarships.php?Id=<?php echo ($Id-1);?>">&laquo; Prev </a></li>
                                 <?php  
                                    }
                                  ?>
                                  <?php  
                                    for($i=1;$i<=$total;$i++){
                                   ?>
                                    <li><a href="admin-scholarships.php?Id=<?php echo $i;?>"><?php echo $i; ?></a></li>  
                                    <?php  
                                        }
                                     ?>
                                    ...
                                    if(!isset($_GET['Id'])){
                                     ...
                                     ?>
                                    <li><a class="pagination-btn" href="admin-scholarships.php?Id=<?php echo ($Id+1);?>">Next &raquo;</a></li>

                                    <?php  
                                        }else{
                                     ?>
                                      <li><a class="pagination-btn" href="admin-scholarships.php?Id=<?php echo ($total);?>">Next &raquo;</a></li>
                                      <?php
                                  }
                                      ?>
                                </ul>
                                  ...
                                  <?php  
                                   ...
                                   ?>
                                    ...
                                    <?php  
                                     ...
                                     ?>
                                      <li><a class="pagination-btn" href="admin-scholarships.php?Id=<?php echo ($totals);?>&searchkey=<?php echo $searchkey;?>">Next &raquo;</a></li>
